	...
	return (
		<>
			<div className="form-group">
				...
				/>
				{errors.title && (
					<span className="error-message">⚠️ {errors.title}</span>
				)}
			</div>
			...
			<div className="form-group row">
				...
				<div className="form-group">
					...
					<input
						...
						onChange={(e) =>
							onPointsChange(e.target.value === "" ? 0 : Number(e.target.value))
						}
						placeholder="Story points"
					/>
					{errors.points && (
						<span className="error-message">⚠️ {errors.points}</span>
					)}
				</div>
			</div>
		</>
